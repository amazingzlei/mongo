package com.example.demo.template.util;

import com.example.demo.template.pojo.BathUpdateOptions;
...
public class BathUpdateUtil {
     ...
     public static int bathUpdate(MongoTemplate mongoTemplate, Class<?> entityClass,
         ...
         return doBathUpdate((DBCollection) mongoTemplate.getCollection(collectionName),
